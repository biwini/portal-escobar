...
#page_1 #id1_2 {border:none;margin: 14px 0px 0px 48px;padding: 0px;border:none;width: 768px;overflow: hidden;}
...
<DIV id="id1_2">
	...
	<table cellpadding=0 cellspacing=0 style="width: 719px;font: 15px 'DINNextLTPro-Regular';">
		<tbody>
			...
			<tr style="height: 22px;">
				...
				<td colspan="2" class="border-dotted-b"><p class="no-margin pd-left-10"><?php echo $t[0]['Equipo']; ?></p></td>
			</tr>
			...
			<tr style="height: 22px;">
				...
				<td class="border-dotted-b"><p class="no-margin medium pd-left-10"><?php echo $t[0]['Patrimony']; ?></p></td>
			</tr>
			<tr style="height: 13px;"></tr>
			<tr style="height: 22px;">
				...
				<td colspan="1" class="border-dotted-b"><p class="no-margin medium pd-left-10"><?php echo $t[0]['NroEquipo']; ?></p></td>
			</tr>
			<tr style="height: 13px;"></tr>
			<tr style="height: 22px;">
				<td colspan="1"><p class="no-margin">Modelo:</p></td>
				<td colspan="2" class="border-dotted-b"><p class="no-margin pd-left-10 medium"><?php echo $t[0]['Modelo']; ?></p></td>
				<td colspan="1"><p class="no-margin" style="padding-left: 20px;">Marca:</p></td>
				<td colspan="1" class="border-dotted-b"><p class="no-margin medium pd-left-10"><?php echo $t[0]['Marca']; ?></p></td>
	...
	<div style="width:100%; border-top: dotted; border-width: thin; margin-top: 7px; padding-bottom: 14px;"></div>
	<?php } ?>
