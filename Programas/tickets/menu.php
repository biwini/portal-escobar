            ...
            <div class="aside-menu">
                <nav class="stacked-menu" id="navegacion1">
                    ...
                    <!-- <span class="icon right icon-circle-down"></span> -->
                        <li><a href="index"><span class="icon left icon-ticket"></span><span class="menu-link">INICIO</span></a></li>
                        <li><a href="consulta-tickets"><span class="icon left icon-search"></span><span class="menu-link">CONSULTAR</span></a></li>
                        <li><a href="mis-tickets"><span class="icon left icon-folder-open"></span><span class="menu-link">MIS TICKETS</span></a></li>
                        <?php if($_SESSION['TICKETS'] == 1){ ?><li><a href="motivos"><span class="icon left icon-list-numbered"></span><span class="menu-link">MOTIVOS</span></a></li> <?php } ?>
                        <?php if($_SESSION['TICKETS'] == 1){ ?><li><a href="tickets"><span class="icon left icon-history"></span><span class="menu-link">SOLICITUDES</span></a></li> <?php } ?>
                        <!-- <?php if($_SESSION['TICKETS'] == 1){ ?><li><a href="informes"><span class="icon left icon-stats-bars"></span><span class="menu-link">INFORMES</span></a></li> <?php } ?> -->
                        <?php if($_SESSION['TICKETS'] == 1){ ?><li><a href="reportes"><span class="icon left icon-stats-bars"></span><span class="menu-link">REPORTES</span></a></li> <?php } ?>
                    </ul>
                </nav>
            </div>
