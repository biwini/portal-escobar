    ...
    if(isset($_SESSION['LOGUEADO'])){
        if($_SESSION['LOGUEADO']){
          ...
          if(isset($_SESSION["TICKETS"])){
            ...
            $ListMotivo = $Motivo->getMotivo();

            $optionMotivo = '';

            foreach ($ListMotivo as $key => $value) {
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="col-md-12" id="reception-content5">
                            <button type="button" class="btn btn-primary pull-left" style="margin-bottom: 10px;" id="open_modal_submotivo">Cargar Sub Motivo</button>
                            <button type="button" class="btn btn-primary pull-left" style="margin-bottom: 10px; margin-left: 5px;" id="open_modal_motivo">Cargar Motivo</button>
                            <a href="#" class="btn btn-success pull-right" onclick="Exporter.export(t_motivo, 'Motivos-Tickets.xls', 'motivos-tickets');return false;">Exportar a Excel</a>
