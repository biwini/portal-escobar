<?php 
	...
	class mail {
		...
		public function send(){
			...
			$Mailer->Username = $this->Username;  // Indica el usuario de  a traves del cual se enviará el correo
			$Mailer->Password = $this->Password;//  password
			...
			if($this->Pdf != ''){
				$Mailer->AddStringAttachment($this->Pdf, 'Vale de combustible Nº'.$this->NumRemito.'.pdf', 'base64', 'application/pdf');
			}
