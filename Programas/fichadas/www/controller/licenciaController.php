<?php
    ...
    class licencia extends Main{
        ...
        public function getLicencias(){
            $this->sql = 'SELECT l.idLicencia,l.idMotivo, m.cMotivo, l.idEmpleado, e.idSecretaria, e.idDependencia, e.apellido, e.nombre, e.legajo, e.nroDocumento, l.dFechaInicio, l.dFechaFin, l.cNotas FROM licencias AS l 
        ...
        public function insertLicense(){
            ...
            $this->sql = 'INSERT INTO licencias (idMotivo, idEmpleado, dFechaInicio, dFechaFin, cNotas, idAlta, dAlta) VALUES (:motivo, :empleado, :inicio, :fin, :notas, :user, :fecha)';
            $this->data = [
                ':motivo'=> $this->motivo,
        ...
        public function updateLicense(){
            ...
            $this->sql = 'UPDATE licencias SET idMotivo = :motivo, idEmpleado = :empleado, dFechaInicio = :inicio, dFechaFin = :fin, cNotas = :notas, idModificado = :user, dModificado = :fecha WHERE idLicencia = :id';
            $this->data = [
                ':motivo'=> $this->motivo,
                ':empleado' => $this->empleado,
                ':inicio' => $this->inicio,
