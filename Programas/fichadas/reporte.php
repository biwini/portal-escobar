<?php
    ...
    // var_dump($listEmployee->from, $listEmployee->to);
...
<html>
    ...
    <body style="padding: 10px;">
        ...
        <button class='ui button basic positive' id='downloadXls' download="Reporte.xml"><i class="file excel icon"></i>Exportar a excel</button>
